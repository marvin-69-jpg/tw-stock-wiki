...
| [[wiki/issuers/capital-sitc\|群益投信]] | 00992A/00982A/00997A 發行商，Capital SITC。揭露風格「主動警示、配息不拆解」、**同家族內 00982A flat 0.8% vs 00992A 階梯 1.2%/1.0%** | issuer, active-etf | 2026-04-18 |
...
| [[wiki/issuers/tsit\|台新投信]] | 00986A/00987A 發行商，Taishin SITC（本土、台新新光金）。**非首批、flat 0.75%（本土 flat 首例）**、產品頁使用被動式模板免責聲明貼於主動式 ETF（類別錯誤揭露漏洞）| issuer, active-etf, local-sitc, flat-fee-local | 2026-04-18 |
