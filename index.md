...
> **Fee disclosure 最新（2026-04-18 round 6–8）**：Round 6 發現第四種揭露不對稱（階梯式 vs flat 第三方壓縮）。Round 7 群益 00992A 確認本土投信 200 億斷點通例。**Round 8 安聯 00984A 推翻「業界通例」**——外資投信採 flat 0.7%，新增**第五種**揭露不對稱（本土階梯 vs 外資 flat）。詳見 [[wiki/mechanisms/active-etf-fee-disclosure]]。
