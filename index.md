...
| [[wiki/issuers/fuhwa\|復華投信]] | 00991A 發行商，Fuhwa SITC（本土、推定華南金）。**警語嵌名（中信後本土第 2 家）**、**揭露品質高端**（活動頁列 4 維選股策略 + 20 個股舉例）、階梯 1.0%/0.8%、保管費 0.035% | issuer, active-etf, local-sitc, warning-in-name | 2026-04-18 |
