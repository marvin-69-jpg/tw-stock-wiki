...
|---|---|---|---|---|---|---|---|
| [[wiki/etfs/00980a\|00980A]] | 主動野村臺灣優選 | 135 億 | **0.75% flat** | Flat | 季配（1/4/7/10）| 全主動（TAIEX TR benchmark）| 游景德 |
| [[wiki/etfs/00985a\|00985A]] | 主動野村台灣 50（增強 50）| 93 億 | **0.45% flat** | Flat | **年配**（12）| **增強指數**（Taiwan 50 benchmark）| 林浩詳 |
| [[wiki/etfs/00999a\|00999A]] | 主動野村臺灣高息 | **尚未掛牌** | **0.70% flat** | Flat | **季配（2/5/8/11）** | 高息策略（雙重架構）| **游景德**（兼任 00980A）|

→ 野村在主動型 ETF 類別**連發 3 檔**，**費率 0.45% / 0.70% / 0.75% 三階**完整光譜，全數 flat 不採階梯。**Round 15 新假說**：野村 flat 費率水準 = **主動裁量權大小**（增強受 Taiwan 50 約束最小 < 高息受股息條件約束中等 < 全主動最自由），非原先 Round 12 的「主動複雜度」。
...
**Round 15 修正（完整光譜）**：ingest 00999A 後，**野村 3 檔 flat 費率光譜完成**：

| ETF | 經理費 | 主動類型 | 裁量約束源 | 裁量空間 |
|---|---|---|---|---|
| 00985A 增強 50 | **0.45% flat** | 增強指數 | Taiwan 50 成分股 | 最小（只能 tilt 權重）|
| **00999A 高息** | **0.70% flat** | **高息策略** | **股息條件 + 雙重策略** | **中等** |
| 00980A 臺灣優選 | **0.75% flat** | 全主動 | TAIEX benchmark（僅參考）| 最大 |

→ **Round 15 新假說：野村費率水準 = 主動裁量權大小**。**推翻 Round 12 的「主動複雜度」假說**（原預測 00999A ≥1.0%）。高息 ETF 因**選股紀律較高、規則相對明確**，實際比全主動費率低。

**同發行商內差異邏輯彙整**（3 家）：
- **群益式**：flat vs 階梯 = **結構類型差**（主題深度）
- **野村式**：flat vs flat = **水準高低差**（主動裁量權）
- **台新式**：flat vs flat = **水準 + 保管費差**（投資地域）
...
| **00985A** | **無警告**（年配未發生）| 無 |
| **00999A** | **「可能為收益平準金且並無保證收益及配息」** | **雙警告（野村最強）**|
...
- **2026-04-18 (round 15)** — ingest 00999A（尚未掛牌），**完成野村 3 檔主動 ETF 費率光譜**（0.45% / 0.70% / 0.75%）。**推翻 Round 12 假說**（原預測 00999A ≥1.0%），**建立 Round 15 新假說：野村 flat 費率 = 主動裁量權大小**。00999A 游景德**兼任 00980A**，野村資深經理人多產品複用模式。季配月份錯開（2/5/8/11 vs 00980A 1/4/7/10）。00999A 警告強度最高（雙警告），反映高息策略結構性依賴平準金。

## Related

- [[wiki/etfs/00980a]] — 旗艦主動型 ETF、全台首檔
- [[wiki/etfs/00985a]] — 增強指數型主動 ETF、首批最低費率（Round 12）
- [[wiki/etfs/00999a]] — 高息策略主動 ETF、尚未掛牌、完成 3 檔光譜（Round 15）
